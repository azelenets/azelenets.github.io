...
export const labCards: LabCardData[] = [
  ...
  },
  {
    ...
    codename: 'P2P_COMMS',
    title: 'SPECTER-LINK',
    desc: 'Browser-native peer-to-peer video, audio, and text chat built on WebRTC + PeerJS. No accounts, no server-side storage — all communication happens directly between peers.',
    status: 'EXPERIMENTAL',
    statusColor: 'bg-primary text-black',
    color: 'primary',
    stats: 'PROTOCOL: WEBRTC + PEERJS',
    action: 'OPEN_CHANNEL',
    icon: 'cell_tower',
    link: 'https://github.com/azelenets/specter-link',
  },
  {
    id: 'PRJ_0330',
    codename: 'SERVERLESS',
