        ...
        <footer className="mt-16 pt-8 border-t border-primary/10">
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-[10px] font-bold text-[#0a66c2]/70 hover:text-[#0a66c2] transition-colors uppercase tracking-widest font-mono border border-[#0a66c2]/30 hover:border-[#0a66c2]/70 px-4 py-2"
            >
