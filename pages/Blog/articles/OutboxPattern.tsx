...
const OutboxPattern: React.FC = () => (
  ...
  >
    ...
    <ArticleImage
      src="/images/articles/outbox-pattern.svg"
      alt="Outbox Pattern architecture diagram - dual write problem vs outbox solution with CDC relay and idempotent consumers"
      caption="Top: the dual write race condition - no safe ordering exists. Bottom: the Outbox Pattern - atomic DB write, durable CDC relay, idempotent consumers."
    />
