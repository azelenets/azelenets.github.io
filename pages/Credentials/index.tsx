  ...
  return (
    <section className="max-w-[1500px] mx-auto w-full space-y-12 px-6 py-16 relative flex-grow">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-4 font-mono">
        <StatCard label="Combat Experience" value="13+ YEARS" progress={75} />
        <StatCard label="Authorization Level" value="MASTER'S [CS]" progress={100} segmented />
        <article className="bg-surface-terminal border border-primary/10 p-6 relative">
          ...
          <p className="text-[10px] text-primary/50 mt-4 uppercase animate-pulse">CRITICAL INFRASTRUCTURE REACHED</p>
        </article>
      </section>
