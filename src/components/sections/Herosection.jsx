...
import { ReactComponent as UpworkIcon } from 'images/icons/upwork.svg';
...
function Herosection({ position, elementDimensions, light }) {
  ...
  const activeParallax = (depth = 15) => {
    const offsetX = (width / 2 - x) / depth;
    const offsetY = (height / 2 - y) / depth;
  ...
  return (
    <section
      id="home"
      className={classnames('home d-flex align-items-center', { light })}
    >
      <div className="container">
        <div className="intro">
          ...
          <ul className="social-icons light list-inline mb-0 mt-4">
            ...
            <li className="list-inline-item">
              <a href="https://www.upwork.com/freelancers/~01706e070af5676710" aria-label="Upwork profile" className="upwork-profile-link">
                <UpworkIcon />
              </a>
            </li>
          </ul>
