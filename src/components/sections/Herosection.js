        ...
        <div className="intro">
          ...
          <ul className="social-icons light list-inline mb-0 mt-4">
            <li className="list-inline-item">
              <a target="_blank" rel="noreferrer" href="https://github.com/azelenets">
                <i className="fab fa-github"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/andrewzelenets">
                <i className="fab fa-linkedin"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a target="_blank" rel="noreferrer" href="https://wellfound.com/u/andrew-zelenets">
                <i className="fab fa-angellist"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a target="_blank" rel="noreferrer" href="https://gist.github.com/azelenets">
                <i className="fa fa-code"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="mailto:andrew.zelenets+github@gmail.com">
